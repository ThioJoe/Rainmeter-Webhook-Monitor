...
# Provide either the path to the AssemblyInfo.cs file, or you can directly pass in the version number using the $(VersionPrefix) build macro
param (
...
try {
    # Get assembly version either from file or direct input
